package com.hxoim.support.customquery.entity;
...
public class QShareQueryplan {
    ...
    public QShareQueryplan(String id, String planId, String userid, String username) {
        this.id = id;
        this.planId = planId;
        this.userid = userid;
